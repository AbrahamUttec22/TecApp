...
class StorageExample : AppCompatActivity() {
    ...
    private fun includesForCreateReference() {
        ...
        var spaceRef = storageRef.child("image_1.jpg")
        ...
        val earthRef = spaceRef.parent?.child("image_1.jpg")
        ...
        // Points to "images"
        imagesRef = storageRef.child("image_1.jpg")
    ...
    fun includesForUploadFiles() {
        ...
        val mountainsRef = storageRef.child("image_1.jpg")

        // Create a reference to 'images/mountains.jpg'
        val mountainImagesRef = storageRef.child("image_1.jpg")
